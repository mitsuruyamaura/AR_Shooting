...
public class EventGenerator : MonoBehaviour
{
    ...
    public void GenerateEnemy(EventDataSO.EventData eventData, Transform eventTran) {
        EnemyController enemy = Instantiate(eventData.eventPrefab, eventTran).GetComponent<EnemyController>();
        StartCoroutine(enemy.SetUpEnemyController(playerController.gameObject, gameManager));
